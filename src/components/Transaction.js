...
const Transaction = () => {
    ...
    const fetchTransactions = async () => {
        try {
            ...
            const endpoint = isAdmin
                ? `/api/v1/cryptos/transactions`
                : `/api/v1/cryptos/transactionsId?userId=${userId}`;
    ...
    const fetchAverageSales = async () => {
        const endpoint = isAdmin
            ? `/api/v1/cryptos/transactions/average/sales`
            : `/api/v1/cryptos/transactions/average/salesId?userId=${userId}`;
        try {
            const response = await fetch(endpoint, {
    ...
    const fetchAveragePurchases = async () => {
        const endpoint = isAdmin
            ? `/api/v1/cryptos/transactions/average/sells`
            : `/api/v1/cryptos/transactions/average/sellsId?userId=${userId}`;
        try {
            const response = await fetch(endpoint, {
                headers: { 'Authorization': `Bearer ${keycloak.token}` }
            });
